...
def train(args):
    ...
    for epoch in range(100000):
        ...
        #Get a mini batch
        minibatch_x, minibatch_y = Data_Formatter.get_minibatch(dataset = x_train, coordinates = coordinates, batch_size = Batch_Size)

        #Train on batch
        batch_loss, _ = model.train_on_batch(minibatch_x,minibatch_y)

        minibatch_x, minibatch_y = Data_Formatter.get_minibatch(dataset = x_valid, coordinates = coordinates, batch_size = Batch_Size)
